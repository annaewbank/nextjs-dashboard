...
export async function createInvoice(prevState: State, formData: FormData) {
  ...
  revalidatePath('/dashboard/invoices'); // Clear invoices route cache and trigger a new request to the server
  redirect('/dashboard/invoices'); // Only reachable if try is successful
}
